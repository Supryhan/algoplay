...
object Processor extends App {
  ...
  //  val inv3 = new Processor[Parent].process(new Inv[Child](new Child))
  //  val inv4 = new Processor[Parent].process(new Inv[Origin](new Child))
  ...
  //  val ct3 = new Processor[Parent].process(new Contr[Child]())

//  new ProcessorInheritor[Origin].process(new Inv[Origin](new Child))
...
//  new ProcessorSuper[Child].process(new Inv[Child](new Child))
